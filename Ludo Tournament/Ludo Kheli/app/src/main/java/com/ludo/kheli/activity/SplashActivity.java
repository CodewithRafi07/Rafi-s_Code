...
import com.dream.zone.BuildConfig;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Function.checkNetworkConnection(SplashActivity.this)) {
            ...
            statusTv.setText("No internet Connection.");
        }
                        ...
                        if (res.get(0).getSuccess() == 1) {
                            ...
                            try {
                                if (BuildConfig.VERSION_CODE < Integer.parseInt(latestVersionCode)) {
                                    ...
                                    statusTv.setText("🕖Ludo Zone সার্ভার এর কাজ চলিতেছে তাই সম্ভবত কিছুটা সময় আপনাকে অপেক্ষা করতে হবে। কিছুক্ষণ পর আবার আসুন। ধন্যবাদ");
                                }
                            }
                            catch (Exception e) {
                                e.printStackTrace();
